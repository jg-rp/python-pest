...
class Expression(ABC):
    ...
    def __init__(self, token: Pair) -> None:
        self.token = token
...
class FilterExpression(Expression):
    ...
    def __init__(self, token: Pair, expression: Expression) -> None:
...
class FilterExpressionLiteral(Expression, Generic[LITERAL_T]):
    ...
    def __init__(self, token: Pair, value: LITERAL_T) -> None:
...
class PrefixExpression(Expression):
    ...
    def __init__(self, token: Pair, operator: str, right: Expression):
...
class FilterQuery(Expression, ABC):
    ...
    def __init__(self, token: Pair, query: JSONPathQuery) -> None:
        super().__init__(token)
        self.query = query
